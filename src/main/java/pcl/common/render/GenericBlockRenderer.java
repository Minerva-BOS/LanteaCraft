...
public class GenericBlockRenderer implements ISimpleBlockRenderingHandler {
	...
	void face(Trans3 t, double x, double y, double z, double dx1, double dy1, double dz1, double dx2, double dy2, double dz2, double u,
	...
	void backFace(Trans3 t, double x, double y, double z, double dx1, double dy1, double dz1, double dx2, double dy2, double dz2, double u,
			double v, double du, double dv) {
	...
	void boxFace(Trans3 t, double x, double y, double z, double dx1, double dy1, double dz1, double dx2, double dy2, double dz2, double nx,
			double ny, double nz, double du, double dv, IIcon icon) {
		if (icon != null) {
			selectTile(icon);
