...
public interface IEnergyHandler {
	...
	/**
	 * Receive a quantity of energy specified from the direction provided.
	 * Return the actual quantity of energy consumed by this
	 * {@link IEnergyHandler}
	 * 
	 * @param direction
	 ...
	 * @param isSimulated
	 *            If this is a simulated request; simulated requests are not to
	 *            be completed by the host as real energy transfers.
	 * @return The quantity of energy accepted by this host. May be the entire
	 ...
	 * the actual quantity of energy exported by this {@link IEnergyHandler}
	 * 
	 * @param direction
	 ...
	 *            If this is a simulated request; simulated requests are not to
	 *            be completed by the host as real energy transfers.
	 * @return The quantity of energy extracted by this host. May be the entire
	 ...
	 * @return If this host can connect to neighbor {@link IEnergyHandler}
	 *         instances.
	 */
	public abstract boolean canConnect(ForgeDirection direction);

	/**
	 * Get the currently stored or buffered energy which can be extracted by
	 * neighbor energy handlers or sinks.
	 * 
	 * @param direction
	 *            The direction to test.
	 * @return The quantity of energy which can be extracted by neighbors on the
	 *         given side
	 */
	...
	/**
	 * Saves the energy handler to a {@link NBTTagCompound} compound for saving
	 * inside a tile-entity NBT structure.
	 * 
	 * @param compound
	...
	/**
	 * Loads the energy handler from a {@link NBTTagCompound} compound for
	 * loading from a tile-entity NBT structure.
	 * 
	 * @param compound
