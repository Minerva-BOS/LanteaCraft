...
public class TileEntityNaquadahGeneratorRenderer extends TileEntitySpecialRenderer {
	...
	public TileEntityNaquadahGeneratorRenderer() {
		activeTexture = LanteaCraft.getResource("textures/models/naquada_generator_on_" + LanteaCraft.getProxy().getRenderMode() + ".png");
		inactiveTexture = LanteaCraft.getResource("textures/models/naquada_generator_off_" + LanteaCraft.getProxy().getRenderMode()
				+ ".png");
	}
	...
	public void func_147500_a(TileEntity tileEntity, double x, double y, double z, float f) {
		if (LanteaCraft.getProxy().isUsingModels()) {
			...
			int dir = tileEntity.func_145832_p();
			...
			FMLClientHandler.instance().getClient().renderEngine
					.bindTexture(((TileEntityNaquadahGenerator) tileEntity).isActive() ? activeTexture : inactiveTexture);
